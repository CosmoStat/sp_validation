...
class LeakageScale:
    ...
    def __init__(self):
        ...
        for key in vars(self._options):
            self._params[key] = getattr(self._options, key)
    ...
    def run(self):
        ...
        if params['close_pair_tolerance']:
            dat_PSF = handle_close_objects(
                dat_PSF,
                params['ra_star_col'],
                params['dec_star_col'],
                params['close_pair_tolerance'],
                self._param['close_pair_mode'],
