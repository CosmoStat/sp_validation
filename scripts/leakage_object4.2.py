...
###function from util.py and correlation.py####################################
...
def corr_any_quant(dat, param, stats_file, label_quant):
    """Corr_any_quant
...
def main(argv=None):
    ...
    #If the --header flag is in the command : print the header and ask the user to input the quantities to compare in the terminal 
    if param.header:
        ...
        corr_any_quant(dat_shear, param, stats_file2, label_quant)
        return 0
