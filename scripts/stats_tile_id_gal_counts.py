...
def main(argv=None):
    ...
    plt.hist(
        n_gal_arr, bins=bins, label="selected galaxies", density=density, alpha=alpha
    )

    plt.hist(
        n_shape_arr, bins=bins, label="measured shapes", density=density, alpha=alpha
    )
