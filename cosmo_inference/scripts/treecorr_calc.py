...
ximinus_hdu.writeto(
    "%s/../data/" % script_dir + root + "/ximinus_" + root + ".fits", overwrite=True
)
xiplus_hdu.writeto(
    "%s/../data/" % script_dir + root + "/xiplus_" + root + ".fits", overwrite=True
)

print(
    "Correlation functions written to {}".format(
        "%s/../data/" % script_dir + root + "/xiplus_minus_" + root + ".fits"
    )
)
