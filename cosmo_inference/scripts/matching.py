...
Cat2 = fits.open(
    "/feynman/work/dap/lcs/lg268561/UNIONS/Catalogues/lensfit_goldshape_2022v1.fits"
)

coord_units = u.degree
Cat1_coord = SkyCoord(
    ra=Cat1[1].data["ra"] * coord_units, dec=Cat1[1].data["dec"] * coord_units
)
Cat2_coord = SkyCoord(
    ra=Cat2[1].data["ra"] * coord_units, dec=Cat2[1].data["dec"] * coord_units
)
