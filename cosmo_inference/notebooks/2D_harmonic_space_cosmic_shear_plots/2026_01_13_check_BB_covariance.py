...
ref = np.sqrt(np.diag(fits.open(f"{path_cosmo_val}/pseudo_cl_cov_{versions[0]}.fits")['COVAR_BB_BB'].data))
...
ref = np.sqrt(np.diag(fits.open(f"{path_cosmo_val}/pseudo_cl_cov_{versions[0]}.fits")['COVAR_EE_EE'].data))
