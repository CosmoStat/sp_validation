...
assert best_fit_method in ["2Dkde", "1Dkde", "weighted_mean"], "Invalid best fit method. Choose one of: '2Dkde', '1Dkde', 'weighted_mean'"
...
# %%
# Plot hyperparameter
os.chdir("/home/guerrini/sp_validation/cosmo_inference/notebooks/2D_harmonic_space_cosmic_shear_plots/")
